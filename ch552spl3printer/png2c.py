...
def main(argv):
  ...
  if not (previewBilevel or saveBilevel):
    ...
    str_out = "__code uint8_t image_data[0x12c0] = {"
    ...
    with open(args[1], 'w') as f:       # save output into image.c
      f.write(str_out)
...
def usage():
  print("To convert to image.c: png2c.py <yourImage.png> <path to image.h>")
  print("To convert to an inverted image.c: png2c.py -i <yourImage.png> <path to image.h>")
